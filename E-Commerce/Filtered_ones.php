  ...
  <div class="button-container">
    ...
    <button id="all" > ALL </button>
        ...
        <form action="Filtered_ones.php" method="POST">
          ...
          <button class="btn btn-success" id="barbie">Barbie</button>
       </form>
          ...
          <button class="button home-button">Board game</button>
       </form>
...
$sql_sttatement = "SELECT * FROM products WHERE products.PCategory = '$category'";
