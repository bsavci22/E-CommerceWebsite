...
<form action="newcustomer.php" style="border:1px solid #ccc" method="POST">
  <div class="container">
    <h1>Sign Up</h1>
    ...
    <input type="text" placeholder="Enter age" name="Member_Age" required>

    <label for="Adress"><b>Adress</b></label>
    <input type="text" name="Member_Address"  placeholder="Type Your Address">
